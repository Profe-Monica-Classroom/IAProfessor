...
try:
    ...
    print("WARNING: 'faster_whisper' library failed to load. Falling back to Google Speech Recognition.")
    ...
    def transcribe(self, audio_path):
        ...
        if self.use_whisper:
            try:
                ...
                print(f"Whisper inference failed: {e}. Switching to fallback.")
        
        # Fallback: Use SpeechRecognition (Online) with pydub chunking
        print("Transcribing with Google Speech Recognition (Online) using chunking...")
        try:
            from pydub import AudioSegment
            from pydub.silence import split_on_silence
        except ImportError:
            print("Error: pydub not installed. Cannot chunk audio. Installing via pip...")
            return []
            ...
            for i, chunk in enumerate(chunks):
                ...
                with sr.AudioFile(chunk_filename) as source:
                    ...
                    try:
                        ...
                        print(f"Chunk {i} failed request")
